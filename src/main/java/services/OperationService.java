...
public class OperationService {
    ...
    public OperationService(CustomerService customerService, MovieService movieService, SaleTicketService saleTicketService) {
        this.customerService = customerService;
        this.movieService = movieService;
        this.saleTicketService = saleTicketService;
    }

    public void moviesOperation() {
        while (true) {
